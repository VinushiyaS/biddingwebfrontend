...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (formData.email === 'vinushiya779@gmail.com' && formData.password === 'Melvin@2002') {
            assignedRole = 'admin';  // Assign 'admin' role for the specific user
        }
        ...
        try {
            ...
            localStorage.setItem('role', assignedRole);  // Store assigned role in local storage
